                                ...
                                <div class="x_content">
                                    ...
                                    <form action="/students/{{ $student->id }}" method="POST" id="demo-form2" data-parsley-validate
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="text" id="residential_address" name="residential_address" value="{{ $student->residential_address }}"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="text" id="cnic_no" name="cnic_no" value="{{ $student->cnic_no }}"
