                        ...
                        <div class="col-md-8 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="/student_exams/{{ $student_exam->id }}" method="POST" id="demo-form2" data-parsley-validate
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="text" id="roll_no" name="roll_no" value="{{ $student_exam->student->roll_no }}"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="number" id="year" name="year" value="{{ $student_exam->teacher_subjects->year }}"
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <select id="student_exam_type" name="student_exam_type" class="form-control @error('student_exam_type') is-invalid @enderror">
                                                  ...
                                                  @foreach ($student_exam_types as $student_exam_type)
                                                      <option value="{{ $student_exam_type }}" {{ ($current_exam_type == $student_exam_type ? "selected":"") }}>{{ ucfirst(trans($student_exam_type)) }}</option>
                                                  @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <select id="department_id" name="department_id" class="form-control @error('department_id') is-invalid @enderror">
                                                  ...
                                                  @foreach ($departments as $department)
                                                      <option value="{{ $department->id }}" {{ ($student_exam->teacher_subjects->subject->department_id == $department->id ? "selected":"") }}>{{ $department->name }}</option>
                                                  @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <select id="subject_id" name="subject_id" class="form-control @error('subject_id') is-invalid @enderror">
                                                  ...
                                                  @foreach ($subjects as $subject)
                                                      <option value="{{ $subject->id }}" {{ ($student_exam->teacher_subjects->subject->id == $subject->id ? "selected":"") }}>{{ $subject->name }}</option>
                                                  @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <select id="batch_id" name="batch_id" class="form-control @error('batch_id') is-invalid @enderror">
                                                  ...
                                                  @foreach ($batches as $batch)
                                                      <option value="{{ $batch->id }}" {{ ($student_exam->student->batch_id == $batch->id ? "selected":"") }}>{{ $batch->name }}</option>
                                                  @endforeach
                                                </select>
                                            </div>
                                        </div>
